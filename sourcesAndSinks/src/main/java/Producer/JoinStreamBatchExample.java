...
public class JoinStreamBatchExample {
    ...
    public static void main(String[] args) {
        ...
        final Dataset<Row> df_stream_output = df_stream.join(df_batch, df_stream.col("userid").equalTo(df_batch.col("userid")), "leftanti");
        ...
        final Dataset<Row> df_final_output = df_stream_output.union(df_batch);
